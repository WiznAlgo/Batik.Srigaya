...
import { ArrowUpRight, Instagram, Link2, Mail, MapPin, Menu, PhoneCall, X } from "lucide-react";
...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[radial-gradient(circle_at_top_left,rgba(200,163,91,0.12),transparent_24%),radial-gradient(circle_at_80%_20%,rgba(255,120,66,0.08),transparent_24%),linear-gradient(180deg,#07130f_0%,#0b201c_32%,#081512_100%)] text-[var(--cream)]">
      ...
      {isMenuOpen && (
        <div className="fixed inset-0 z-[100] flex flex-col bg-black/95 p-6 backdrop-blur-xl animate-[fadeIn_0.3s_ease-out]">
              ...
              {contactLinks.map((item) => {
                ...
                return (
                  <a
                    ...
                    className="group flex items-center justify-between gap-4 rounded-2xl border border-white/10 bg-white/5 px-4 py-4 transition duration-300 hover:-translate-y-0.5 hover:border-[rgba(224,194,127,0.26)] hover:bg-white/8"
                  >
